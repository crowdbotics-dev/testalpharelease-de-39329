...
## Project Structure
    ...
    ├── testalpharelease_de_39329  # Django project configurations
...
1. Clone this repo and `cd testalpharelease_de_39329`
...
2. Clone this repo and `cd testalpharelease_de_39329`
